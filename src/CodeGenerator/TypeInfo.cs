...
namespace CodeGenerator
{
    public class TypeInfo
    {
        public static readonly Dictionary<string, string> WellKnownTypes = new Dictionary<string, string>()
        {
            ...
            { "unsigned int", "uint" },
            { "ImVec2", "Vector2D<float>" },
            { "ImVec2_Simple", "Vector2D<float>" },
            { "ImVec3", "Vector3D<float>" },
            { "ImVec4", "Vector4D<float>" },
            { "ImWchar16", "ushort" }, //char is not blittable
            { "ImVec4_Simple", "Vector4D<float>" },
            ...
            { "float[2]", "Vector2D<float>*" },
            { "float[3]", "Vector3D<float>*" },
            { "float[4]", "Vector4D<float>*" },
            { "int[2]", "int*" },
            { "int[3]", "int*" },
            { "int[4]", "int*" },
            { "float&", "float*" },
            { "ImVec2[2]", "Vector2D<float>*" },
            { "char* []", "byte**" },
        ...
        public static readonly Dictionary<string, string> WellKnownDefaultValues = new Dictionary<string, string>()
        {
            ...
            { "NULL", "null"},
            { "nullptr", "null"},
            { "ImVec2(0,0)", "new Vector2D<float>()" },
            { "ImVec2(0.0f,0.0f)", "new Vector2D<float>()" },
            { "ImVec2(-FLT_MIN,0)", "new Vector2D<float>(-float.MinValue, 0.0f)" },
            { "ImVec2(-1,0)", "new Vector2D<float>(-1, 0)" },
            { "ImVec2(1,0)", "new Vector2D<float>(1, 0)" },
            { "ImVec2(1,1)", "new Vector2D<float>(1, 1)" },
            { "ImVec2(0,1)", "new Vector2D<float>(0, 1)" },
            { "ImVec4(0,0,0,0)", "new Vector4D<float>()" },
            { "ImVec4(1,1,1,1)", "new Vector4D<float>(1, 1, 1, 1)" },
            { "ImVec4(0,0,0,-1)", "new Vector4D<float>(0, 0, 0, -1)" },
